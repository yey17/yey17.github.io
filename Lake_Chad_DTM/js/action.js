var action = function(data)
{
  ...
  var cf_adm0_dep=process.dimension(function (d){return d.adm0_dep;});
  var cf_adm1_dep=process.dimension(function (d){return d.adm1_dep;});
  var cf_adm1_arr=process.dimension(function (d){return d.adm1_arr;});
  var cf_adm2_arr=process.dimension(function (d){return d.adm2_arr;});
  var cf_adm2_arr_code=process.dimension(function (d){return d.ADM2_ID;});
  var cf_adm3_arr=process.dimension(function (d){return d.adm3_arr;});
  var cf_adm2_dep=process.dimension(function (d){return d.adm2_dep;});
  ...
  //var periode=cf_periode.group().reduceSum(function(d) { return d.reason_insurg_ind; } );
  ...
  var adm0_dep=cf_adm0_dep.group().reduceSum(function(d) { return d.individual; } );
  var adm1_dep=cf_adm1_dep.group().reduceSum(function(d) { return d.individual; } );
  var adm1_arr=cf_adm1_arr.group().reduceSum(function(d) { return d.individual; } );
  var adm2_arr=cf_adm2_arr.group().reduceSum(function(d) { return d.individual; } );
  var adm2_arr_code=cf_adm2_arr_code.group().reduceSum(function(d) { return d.individual; } );
  ...
  var adm2_color=cf_adm2_arr_code.group().reduce(
    //add
...
var graph_time = dc.rowChart("#time");
  ...
  map
    ...
    .overlayGeoJson(admin_2.features, "Arrondissement", function(d) {return d.properties.ADM2_CODE;})
    .projection(d3.geo.mercator().center([17,11]).scale(2000))
